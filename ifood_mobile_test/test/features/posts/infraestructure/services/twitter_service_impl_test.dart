...
main() {
  ...
  group('getPostsById', () {
    ...
    group('success cases', () {
      test(
        ...
        final successString = fixtureReader(
          'features/infraestructure/services/twitter_service/get_posts_by_id_200.json',
        );
    ...
    group('failure cases', () {
      ...
      test(
          'A invalidPatternId must be returned'
          ' when the http call has no code 200 and the server responds with'
          ' failure against the invalid id pattern', () async {
        final failureBody = fixtureReader(
          'features/infraestructure/services/twitter_service/get_posts_by_id_invalid_pattern_id_200.json',
        );
        final failureResponse = Response(
          failureBody,
          200,
        ...
        expect(
          result,
          Left<GetPostsByIdFailure, List<PostEntity>>(
            GetPostsByIdFailure.invalidPatternId(),
          ),
        );
      });
      ...
      test(
          ...
          ' when the http call has no code 200 and the server responds with'
          ' user not found', () async {
        final failureBody = fixtureReader(
          'features/infraestructure/services/twitter_service/get_posts_by_id_user_not_found_id_200.json',
        );
        final failureResponse = Response(
          failureBody,
          200,
        ...
        expect(
          result,
          Left<GetPostsByIdFailure, List<PostEntity>>(
            GetPostsByIdFailure.userNotFound(),
          ),
        );
      });
    });
  ...
  group('getUserByUsername', () {
    ...
    group('success cases', () {
      test(
          ...
          ' when the http call has code 200', () async {
        final successString = fixtureReader(
          'features/infraestructure/services/twitter_service/get_user_by_name_success_200.json',
        );
        final successResponse = Response(
          successString,
          200,
    ...
    group('failure cases', () {
      test(
        ...
        final failureString = fixtureReader(
          'features/infraestructure/services/twitter_service/get_user_by_name_not_found_200.json',
        );
        final failureResponse = Response(
          failureString,
          200,
      ...
      test(
        ...
        final failureString = fixtureReader(
          'features/infraestructure/services/twitter_service/get_user_by_name_errors_empty_200.json',
        );
        final failureResponse = Response(
          failureString,
          200,
